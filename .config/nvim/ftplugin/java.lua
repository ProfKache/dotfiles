...
local workspace_dir = vim.env.HOME .. "/IdeaProjects/" .. project_name
		...
		java = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-8",
						path = vim.env.HOME .. "/.asdf/installs/java/adoptopenjdk-8.0.402+6",
					},
					{
						name = "JavaSE-10",
						path = vim.env.HOME .. "/.asdf/installs/java/openjdk-10.0.2",
					},
					{
						name = "JavaSE-12",
						path = vim.env.HOME .. "/.asdf/installs/java/openjdk-12.0.2",
					},
					{
						name = "JavaSE-14",
						path = vim.env.HOME .. "/.asdf/installs/java/adoptopenjdk-14.0.1+7.1",
					},
					{
						name = "JavaSE-15",
						path = vim.env.HOME .. "/.asdf/installs/java/adoptopenjdk-15.0.2+7",
					},
					{
						name = "JavaSE-17",
					...
					{
						name = "JavaSE-21",
						path = vim.env.HOME .. "/.asdf/installs/java/adoptopenjdk-21.0.2+13.0.LTS",
					},
				},
			},
			maven = {
